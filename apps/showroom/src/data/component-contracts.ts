...
const props: Record<string, readonly string[]> = {
  ...
  Prose: ["children", "article attributes"],
  ...
  PostCard: ["post", "headingLevel", "article attributes"],
...
const nativeUsage: Record<string, string> = {
  ...
  Prose: '<article class="cf-prose">…</article>',
  ...
  PostCard: '<article class="cf-post-card">…</article>',
