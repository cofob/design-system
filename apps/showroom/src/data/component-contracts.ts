...
const props: Record<string, readonly string[]> = {
  ...
  Breadcrumbs: ["items", "label", "nav attributes"],
  ...
  Radio: ["checked/defaultChecked", "name", "value", "label", "description", "size", "input attributes"],
  RadioGroup: [
    "value/defaultValue",
    "name",
    "label",
  ...
  Progress: ["value", "max", "label", "valueLabel", "animated", "showValue", "progress attributes"],
  Spinner: ["label", "size", "span attributes"],
  CircularProgress: [
    "value",
    "max",
    "label",
  ...
  Skeleton: ["variant", "width", "height", "span attributes"],
  AudioPlayer: ["src", "durationHint", "disabled", "labels", "audioProps", "div attributes"],
  VideoPlayer: [
    "src",
    "label",
    "caption",
  ...
  Separator: ["orientation", "decorative", "separator attributes"],
  Pagination: [
    "page/currentPage",
    "totalPages/items",
  ...
  Stepper: ["items", "currentStep", "label", "orientation", "onStepChange", "nav attributes"],
  Dialog: [
    "open/defaultOpen",
    "onOpenChange",
    "trigger",
...
const parameterTypes: Record<string, string> = {
  ...
  step: "number",
  showValue: "boolean",
  formatValue: "(value: number) => renderable content",
  "root/input attributes": "root attributes plus an inputProps object",
  "progress attributes": "native progress attributes",
  "span attributes": "native span attributes",
  "separator attributes": "native hr/span attributes",
  decorative: "boolean",
  width: "CSS length",
  height: "CSS length",
  ...
  audioProps: "native audio element attributes",
  videoProps: "native video element attributes",
...
const parameterDescriptions: Record<string, string> = {
  ...
  accept: "Filters selectable files using native MIME types or file extensions.",
  disabled: "Prevents user interaction while preserving visible context.",
  maxFiles: "Maximum number of files retained in the selection.",
  maxSize: "Rejects individual files larger than this byte count.",
  onFilesChange: "Reports the complete accepted file selection after add or remove.",
  min: "Lowest allowed range value.",
  max: "Highest allowed range or progress value.",
  step: "Increment used by the native range input.",
  showValue: "Shows formatted output beside the slider label.",
  formatValue: "Formats visible numeric output without changing the underlying value.",
  "root/input attributes": "Forwards root attributes and accepts native input attributes through inputProps.",
  "progress attributes": "Forwards native attributes to the progress element.",
  "span attributes": "Forwards native attributes to the status or placeholder span.",
  "separator attributes": "Forwards native attributes to the horizontal rule or vertical separator.",
  decorative: "Removes separator semantics when the line is purely visual.",
  width: "Sets an explicit placeholder width.",
  height: "Sets an explicit placeholder height.",
  currentStep: "Identifies the current step and derives complete/upcoming states.",
  onStepChange: "Turns enabled steps into buttons and reports activation.",
  side: "Edge from which the drawer enters.",
  src: "Media URL loaded by the native audio or video element.",
  durationHint: "Known duration used before metadata loads or when duration metadata is unavailable.",
  audioProps: "Forwards preload, cross-origin, event, and other native attributes to the audio element.",
  videoProps: "Forwards muted, poster, preload, cross-origin, event, and other native video attributes.",
  animated: "Enables optional progress motion while preserving reduced-motion behavior.",
  onInputValueChange: "Reports edits to the visible autocomplete query.",
  noResultsLabel: "Message shown when filtering produces no options.",
  ...
  removeLabel: "Accessible name for a remove action; FileUpload can derive it from each file.",
  ...
  prompt: "Primary instruction content; terminal prompts are visual and excluded from copied command text.",
  ...
  orientation: "Sets layout and the matching keyboard navigation axis or ARIA orientation.",
  ...
  name: "Identifies a native form field or named entity, depending on the component.",
...
const requiredParameters: Record<string, readonly string[]> = {
  ...
  Combobox: ["label", "options"],
  FileUpload: ["label"],
  Slider: ["label"],
  Stepper: ["items", "currentStep"],
  AudioPlayer: ["src"],
  CircularProgress: ["value", "label"],
  VideoPlayer: ["label"],
...
const componentParameterTypes: Record<string, Record<string, string>> = {
  ...
  RadioGroup: {
    options: "readonly { value; label; description?; disabled? }[]",
  ...
  Slider: {
    "value/defaultValue": "number; controlled or initial value",
  ...
  CircularProgress: {
    value: "number",
    formatValue: "(percentage: number, value: number, max: number) => renderable content",
  },
};
...
const componentParameterDefaults: Record<string, Record<string, string>> = {
  ...
  Combobox: { noResultsLabel: '"No results found"' },
  FileUpload: {
    "files/defaultFiles": "[]",
    multiple: "false",
    prompt: '"Choose files or drag them here"',
  },
  Slider: { "value/defaultValue": "0", showValue: "true" },
  Progress: { max: "100", animated: "false", showValue: "true" },
  Spinner: { label: '"Loading"', size: '"md"' },
  CircularProgress: { max: "100", size: '"md"', animated: "false", showValue: "true" },
  Skeleton: { variant: '"rectangle"' },
  VideoPlayer: { aspectRatio: '"16 / 9"' },
  Separator: { orientation: '"horizontal"', decorative: "false" },
  Breadcrumbs: { label: '"Breadcrumb"' },
  Stepper: { label: '"Progress"', orientation: '"horizontal"' },
  Drawer: { triggerLabel: '"Open drawer"', closeLabel: '"Close drawer"', side: '"right"' },
};
...
const stateOverrides: Record<string, readonly string[]> = {
  ...
  Radio: ["unchecked", "checked", "focus-visible", "disabled"],
  RadioGroup: ["vertical", "horizontal", "selected", "error", "disabled"],
  Combobox: ["closed", "open", "filtered", "selected", "empty", "disabled"],
  FileUpload: ["empty", "dragging", "selected files", "rejected", "disabled"],
  Slider: ["minimum", "value", "maximum", "focus-visible", "disabled"],
  Progress: ["determinate", "indeterminate", "animated", "value shown", "value hidden"],
  Spinner: ["sm", "md", "lg", "reduced motion"],
  CircularProgress: ["sm", "md", "lg", "animated", "0–100%", "custom maximum", "hidden value"],
  Skeleton: ["text", "rectangle", "circle", "reduced motion"],
  AudioPlayer: ["paused", "playing", "seeking", "muted", "volume", "disabled", "play failure"],
  VideoPlayer: [
    "not started",
    "paused",
    "playing",
  ...
  Breadcrumbs: ["ancestors", "current page", "wrapped"],
  Stepper: ["complete", "current", "upcoming", "horizontal", "vertical"],
  Dialog: ["closed", "open", "cancelled"],
  Drawer: ["closed", "left", "right", "top", "bottom", "cancelled"],
...
const reactUsage: Record<string, string> = {
  ...
  RadioGroup: '<RadioGroup name="plan" label="Plan" options={plans} defaultValue="pro" />',
  Combobox: '<Combobox label="Framework" options={frameworks} />',
  FileUpload: '<FileUpload label="Attachments" multiple />',
  Slider: '<Slider label="Volume" defaultValue={60} />',
  ...
  Progress: '<Progress label="Uploading" value={64} animated showValue />',
  Spinner: '<Spinner label="Loading results" />',
  CircularProgress: '<CircularProgress label="Uploading assets" value={64} animated showValue />',
  Skeleton: '<Skeleton width="100%" height="4rem" />',
  AudioPlayer: '<AudioPlayer src="/audio/note.ogg" durationHint={83} />',
  VideoPlayer: '<VideoPlayer src="/video/demo.webm" label="Product demo" />',
  Separator: "<Separator decorative />",
  Pagination: "<Pagination currentPage={1} items={items} />",
  Breadcrumbs: "<Breadcrumbs items={breadcrumbs} />",
  Stepper: '<Stepper items={steps} currentStep="details" />',
  Dialog: '<Dialog trigger="Open" title="Confirm">Content</Dialog>',
  Drawer: '<Drawer trigger="Open filters" title="Filters">Content</Drawer>',
...
const svelteUsage: Record<string, string> = {
  ...
  Radio: '<Radio name="plan" value="pro" label="Pro" bind:checked />',
  RadioGroup: '<RadioGroup name="plan" label="Plan" options={plans} bind:value />',
  Combobox: '<Combobox label="Framework" options={frameworks} bind:value />',
  FileUpload: '<FileUpload label="Attachments" multiple bind:files />',
  Slider: '<Slider label="Volume" bind:value />',
  ...
  AudioPlayer: '<AudioPlayer src="/audio/note.ogg" durationHint={83} />',
  CircularProgress: '<CircularProgress label="Uploading assets" value={64} />',
  VideoPlayer: '<VideoPlayer src="/video/demo.webm" label="Product demo" />',
...
const nativeUsage: Record<string, string> = {
  ...
  Radio: '<label class="cf-radio"><input type="radio" name="plan" value="pro" /> Pro</label>',
  RadioGroup: '<fieldset class="cf-radio-group"><legend>Plan</legend>…</fieldset>',
  Combobox:
  ...
  FileUpload: '<label class="cf-file-upload__dropzone"><input type="file" multiple />Choose files</label>',
  Slider: '<label class="cf-slider">Volume <input class="cf-slider__control" type="range" /></label>',
  ...
  Spinner: '<span class="cf-spinner" role="status"><span class="cf-visually-hidden">Loading</span></span>',
  CircularProgress:
  ...
  Skeleton: '<span class="cf-skeleton" aria-hidden="true"></span>',
  AudioPlayer:
  ...
  Separator: '<hr class="cf-separator" />',
  Pagination: '<nav class="cf-pagination" aria-label="Pagination">…</nav>',
  Breadcrumbs: '<nav class="cf-breadcrumbs" aria-label="Breadcrumb"><ol>…</ol></nav>',
  Stepper: '<nav class="cf-stepper" aria-label="Progress"><ol>…</ol></nav>',
  Dialog: '<dialog class="cf-dialog" data-cf-dialog>Content</dialog>',
  Drawer: '<dialog class="cf-drawer" data-cf-drawer data-side="right">Content</dialog>',
